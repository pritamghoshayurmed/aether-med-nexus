    ...
    <div className="min-h-screen bg-gradient-background p-4 md:p-6 pb-24">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            { icon: Video, label: "Start Video Call", variant: "medical" as const },
            { icon: Brain, label: "AI Symptom Check", variant: "glass" as const },
            { icon: Heart, label: "Check Vitals", variant: "glass" as const },
            { icon: Search, label: "Find Doctor", variant: "glass" as const },
          ].map((action, index) => (
            <MedicalButton
              key={action.label}

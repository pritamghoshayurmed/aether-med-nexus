    ...
    switch (userRole) {
      ...
      case "doctor":
        return [
          ...
          { icon: Activity, label: "Analytics", path: "/dashboard/doctor/analytics", key: "analytics" },
        ];
      case "hospital":
        return [
          ...
          { icon: Calendar, label: "Appointments", path: "/dashboard/hospital/appointments", key: "appointments" },
